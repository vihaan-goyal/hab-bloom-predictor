...
|---|---|---|---|
| Sept 12 | Ask counselor to name a science teacher as adult sponsor | Vihaan | open |
| Sept 19 | Fallback: any faculty member agrees to sponsor | Vihaan | open |
...
- Not needed: Form 2 (Qualified Scientist) — optional for computational work on
  public data; Form 3 (Risk Assessment) — no hazards; Forms 4–7 — no human,
  vertebrate, PHBA, or continuation.
- Regulated Research Institution form: no; work done at home on public data.
